        ...
        <nav className="fixed bottom-0 w-full bg-[#0d0d1f] border-t border-[#2a2a4a] py-2 z-50">
            <ul className="flex justify-around items-center list-none m-0 p-0">
                ...
                >
                    <Clapperboard 
                        size={24} 
                        color={isActive("/film") ? "#00ffff" : "gray"} 
                        className="group-hover:text-cyan-400 transition-colors"
                    />
                    <span className={`text-xs font-medium transition-colors ${isActive("/film") ? "text-[#00ffff] font-bold" : "text-gray-500"} group-hover:text-cyan-400`}>
                        FILM
                    </span>
                </li>
                ...
                >
                    <Tv 
                        size={24} 
                        color={isActive("/serie-tv") ? "#00ffff" : "gray"} 
                        className="group-hover:text-cyan-400 transition-colors"
                    />
                    <span className={`text-xs font-medium transition-colors ${isActive("/serie-tv") ? "text-[#00ffff] font-bold" : "text-gray-500"} group-hover:text-cyan-400`}>
                        SERIE TV
                    </span>
                </li>
                ...
                >
                    <BookMarked 
                        size={24} 
                        color={isActive("/la-mia-lista") ? "#00ffff" : "gray"} 
                        className="group-hover:text-cyan-400 transition-colors"
                    />
                    <span className={`text-xs font-medium ${isActive("/la-mia-lista") ? "text-[#00ffff] font-bold" : "text-gray-500"} group-hover:text-cyan-400 transition-colors`}>
                        LISTA
                    </span>
                </li>
                ...
                >
                    <User 
                        size={24} 
                        color={isActive("/account") ? "#00ffff" : "gray"} 
                        className="group-hover:text-cyan-400 transition-colors"
                    />
                    <span className={`text-xs font-medium ${isActive("/account") ? "text-[#00ffff] font-bold" : "text-gray-500"} group-hover:text-cyan-400 transition-colors`}>
                        ACCOUNT
                    </span>
                </li>

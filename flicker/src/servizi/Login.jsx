        ...
        <div className="flex flex-col items-center min-h-screen bg-[#06000c] text-white p-6 font-sans select-none">
            ...
            <div className="w-full max-w-sm space-y-6">
                ...
                <div className="space-y-3">
                    {/* Google */}
                    <button type="button" onClick={() => handleSocialLogin('Google')} className="relative w-full flex items-center py-3 px-4 border border-gray-800 rounded-xl bg-[#0b0411]/40 transition hover:border-gray-700">
                        ...
                        <span className="absolute inset-0 flex items-center justify-center text-xs text-gray-400 font-bold tracking-wide pointer-events-none">Continua con Google</span>
                    </button>

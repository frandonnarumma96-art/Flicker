...
export function StepPiattaforme({ onboardingData, setOnboardingData, onNext, onSkip }) {
    ...
    const piattaformeSelezionate = onboardingData?.piattaforme || []

    function handleTogglePiattaforma(nomePiattaforma) {
        let nuovePiattaforme;
        if (piattaformeSelezionate.includes(nomePiattaforma)) {
            
            nuovePiattaforme = piattaformeSelezionate.filter(p => p !== nomePiattaforma)
        } else {
            
            nuovePiattaforme = [...piattaformeSelezionate, nomePiattaforma]
        }
        
      
        setOnboardingData(prev => ({ ...prev, piattaforme: nuovePiattaforme }))
    }
